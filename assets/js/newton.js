...

{
  ...
  {
  var s
  var alert4 = "Preencha 3 valores para calcular o 4º."
  ...
  if (opcao != 2) {
      ...
      s = s.replace(",", ".")
        ...
        if(!isFloat(s))
        {
          alert("Taxa de Juros deve ser um valor numerico, tendo a vírgula(,) como delimitador da parte fracionária.")
          return
        }
  ...
  if (opcao != 3) {
      ...
      s = s.replace(",", ".")
          if(!isFloat(s))
          {
                alert("Valor da prestação deve ser um valor numerico, tendo a vírgula(,) como delimitador dos centavos.")
                return
          }
  ...
  if (opcao != 4) {
      ...
      s = s.replace(",", ".")
          ...
          if(!isFloat(s))
          {
                alert("Valor do Financiamento deve ser um valor numerico maior que zero, tendo a vírgula(,) como delimitador dos centavos.")
                return
          }
